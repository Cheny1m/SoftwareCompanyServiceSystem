...
public class TokenUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Date.from(currentTime.atZone(ZoneId.systemDefault()).toInstant()).getTime());
        Date date = new Date(1608113143000L);
    ...
    public String createRefreshToken(AuthUserDetails authUserDetails) {
        ...
        Claims claims = Jwts.claims().setSubject(authUserDetails.getUsername());
        claims.put(SecurityConstant.AUTHORITIES, Collections.singletonList(Scopes.REFRESH_TOKEN.authority()));
