...
public class PrivController {
     ...
     * @throws IOException
     */
    @NewLog(value = "新增权限",type = LogConstant.OPERATION)
     ...
     * @throws IOException
     */
    @NewLog(value = "获取对应权限信息",type = LogConstant.OPERATION)
    @ApiOperation(value = "获取对应权限信息")
     ...
     * @throws IOException
     */
    @NewLog(value = "更新对应权限信息",type = LogConstant.OPERATION)
    @ApiOperation(value = "更新对应权限信息")
     ...
     * @throws IOException
     */
    @NewLog(value = "删除对应权限",type = LogConstant.OPERATION)
    @ApiOperation(value = "删除对应权限")
