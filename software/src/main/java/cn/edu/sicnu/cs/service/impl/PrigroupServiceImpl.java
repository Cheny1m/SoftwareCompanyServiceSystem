...
//    )
    ...
    @Override
    ////@Cacheable(value = "privsevict",cacheNames = "privsevict",key = "#pgroupid.toString()+'--'+#root.methodName.toString().toString()",unless = "#result==null")
    ...
    @Override
    ////@Cacheable(value = "privsevict",cacheNames = "privsevict",key = "#root.methodName.toString().toString()+'--'+#groupid.toString()+'--'+#roleid.toString()",unless = "#result==null")
    ...
    @Override
    ////@Cacheable(value = "privsevict",cacheNames = "privsevict",key = "#root.methodName.toString().toString()+'--'+#groupid.toString()+'--'+#roleid.toString()+'--'+#zibiaoti.toString()",unless = "#result==null")
    ...
    @Override
    ////@Cacheable(value = "privsevict",cacheNames = "privsevict",key = "#root.methodName.toString().toString()+'--'+#groupid.toString()+#zibiaoti.toString()",unless = "#result==null")
    ...
    @Override
//    ////@Cacheable(value = "privsevict",cacheNames = "privsevict",key = "#root.methodName.toString().toString()",unless = "#result==null")
    ...
    @Override
    ////@Cacheable(value = "privsevict",cacheNames = "privsevict",key = "#root.methodName.toString().toString()+'--'+#privGroup.prigroupname",unless = "#result==null")
