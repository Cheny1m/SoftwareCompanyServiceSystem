...
public class User  implements Serializable {
    ...
    public User(String username, String phone, String email, Integer cateinfo, int roleid, String password, int uvisits, String ulocked, String udeleted) {
        this.username = username;
        this.ugender = "f";
        this.uemail = email;
        this.umobile = phone;
        this.ucompanyId=cateinfo;
        this.uroleId = roleid;
